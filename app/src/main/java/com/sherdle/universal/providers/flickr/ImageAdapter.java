...
public class ImageAdapter extends InfiniteRecyclerViewAdapter {
	...
	public ImageAdapter(Context context, ArrayList<FlickrItem> listData, LoadMoreListener listener) {
	...
	protected void doBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
		if (holder instanceof ItemViewHolder){
			Picasso.get()
					.load(listData.get(position).getThumbUrl())
	...
	private void startImagePagerActivity(int position) {
		...
		ArrayList<FlickrItem> underlying =  new ArrayList<FlickrItem>();
